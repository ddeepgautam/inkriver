const CACHE = "inkriver-v41-auth-error-feedback";
const CORE = ["/", "/index.html", "/src/app.js?v=20260815-auth-error-fix-2", "/src/styles.css?v=20260802-admin-blog-search-spacing-1", "/manifest.webmanifest", "/src/icon.svg"];
