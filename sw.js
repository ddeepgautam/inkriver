const CACHE = "inkriver-v30-business-network";
const CORE = ["/", "/index.html", "/src/app.js?v=20260726-business-network", "/src/styles.css?v=20260726-business-network", "/manifest.webmanifest", "/src/icon.svg"];
