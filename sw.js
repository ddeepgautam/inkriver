const CACHE = "inkriver-v20-admin-fixes";
const CORE = ["/", "/index.html", "/src/app.js?v=20260716-admin-fixes", "/src/styles.css?v=20260716-admin-fixes", "/manifest.webmanifest", "/src/icon.svg"];
