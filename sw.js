const CACHE = "inkriver-v34-admin-business-directory";
const CORE = ["/", "/index.html", "/src/app.js?v=20260726-admin-business-directory-v2", "/src/styles.css?v=20260726-admin-business-directory-v2", "/manifest.webmanifest", "/src/icon.svg"];
