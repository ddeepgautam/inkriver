const CACHE = "inkriver-v26-user-author-fixes";
const CORE = ["/", "/index.html", "/src/app.js?v=20260717-user-author-fixes", "/src/styles.css?v=20260717-user-author-fixes", "/manifest.webmanifest", "/src/icon.svg"];
