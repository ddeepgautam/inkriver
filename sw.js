const CACHE = "inkriver-v31-business-media";
const CORE = ["/", "/index.html", "/src/app.js?v=20260726-business-media", "/src/styles.css?v=20260726-business-media", "/manifest.webmanifest", "/src/icon.svg"];
