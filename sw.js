const CACHE = "inkriver-v32-business-pagination";
const CORE = ["/", "/index.html", "/src/app.js?v=20260726-business-pagination", "/src/styles.css?v=20260726-business-pagination", "/manifest.webmanifest", "/src/icon.svg"];
