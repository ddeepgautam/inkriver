const CACHE = "inkriver-v24-support-system";
const CORE = ["/", "/index.html", "/src/app.js?v=20260717-support-system", "/src/styles.css?v=20260717-support-system", "/manifest.webmanifest", "/src/icon.svg"];
